const tr = {
  ...
  sendMagicLink: 'E-posta ile Giriş Linki Gönder',
  orDivider: 'veya',
  forgotTitle: 'Şifre Sıfırlama',
  forgotDesc: 'E-posta adresinizi girin, şifre sıfırlama linki göndereceğiz.',
  sendResetLink: 'Sıfırlama Linki Gönder',
  backToLogin: 'Giriş sayfasına dön',
  linkSentTitle: 'Link Gönderildi!',
  magicLinkSent: 'Giriş linki e-posta adresinize gönderildi. Lütfen gelen kutunuzu kontrol edin.',
  resetLinkSent: 'Şifre sıfırlama linki e-posta adresinize gönderildi. Lütfen gelen kutunuzu kontrol edin.',
  ...
  passwordResetError: 'Şifre güncellenirken bir hata oluştu. Lütfen tekrar deneyin.',
  magicLinkError: 'Giriş linki gönderilirken bir hata oluştu.',
  resetEmailError: 'Sıfırlama linki gönderilirken bir hata oluştu.',
